 ...
 */
 ZitiContext.prototype._getMatchConfigTunnelerClientV1 = function(config, hostname, port) {
 ...
 */
 ZitiContext.prototype._getMatchConfigInterceptV1 = function(config, hostname, port) {
   if (isUndefined(config)) {
     return false;
   }
